...
|-----------|-------|--------|-------|
| LIBERO | 4 suites | 118 | Manipulation generalization |
| CALVIN | ABC→D | 31 | Long-horizon, language |
| Meta-World | ML-10/45 | - | Multi-task dexterity |
| SimplerEnv | 5 tasks | 40 | Sim-to-real transfer |
| RoboTwin v1/v2 | 50 tasks | 39 | Dual-arm, bimanual |
