...
[![Models](https://img.shields.io/badge/Models-156-purple?style=flat-square)](data/models/)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-8-green?style=flat-square)](data/benchmarks/)
[![AI Reviews](https://img.shields.io/badge/Paper_Reviews-156-orange?style=flat-square)](data/ai_reviews/)
...
**156 VLA models** · **8 benchmarks** · **156 AI paper reviews** · **Auto-updated from arXiv**
...
VLA-Tracker includes **156 AI-generated seminar-style paper reviews** for every tracked model. Each review covers:
...
**156 reviews are PDF-verified** — numbers cross-checked against actual paper tables.
...
| **YAML** | [data/models/](data/models/) | Individual model files (156 files) |
...
|-----------|-------|--------|-------|-------|
| [LIBERO](data/benchmarks/libero.yaml) | 4 suites | 78 | Manipulation generalization | NeurIPS 2023 |
| [CALVIN](data/benchmarks/calvin.yaml) | ABC→D | 26 | Long-horizon, language | RA-L 2022 |
| [SimplerEnv](data/benchmarks/simpler_env.yaml) | 5 tasks | 27 | Sim-to-real transfer | NeurIPS 2024 |
| [RoboTwin v1/v2](data/benchmarks/robotwin.yaml) | 50+ tasks | 27 | Bimanual manipulation | CVPR 2025 |
...
```
├── data/
│   ├── models/              # 156 model YAML files (source of truth)
│   ├── benchmarks/          # 8 benchmark definitions
│   ├── ai_reviews/          # 156 AI-generated paper reviews (markdown)
...
- AI reviews are generated by Claude and may contain inaccuracies (156/156 are PDF-verified)
