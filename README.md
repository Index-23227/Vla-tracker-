...
[![Models](https://img.shields.io/badge/Models-270-purple?style=flat-square)](data/models/)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-8-green?style=flat-square)](data/benchmarks/)
[![AI Reviews](https://img.shields.io/badge/Paper_Reviews-270-orange?style=flat-square)](data/ai_reviews/)
...
**270 VLA models** · **8 benchmarks** · **270 AI paper reviews** · **Auto-updated from arXiv**
...
| Paper reviews | None | **270 AI-generated seminar-style reviews** |
...
| 3 | **Qwen-RobotManip** | **99.2** | Jun 2026 | arXiv | Qwen3.5-4B + flow-matching DiT (RoboChallenge #1) |
| 4 | **PriorVLA** | **99.05** | May 2026 | — | Dual-expert flow matching (pi0.5 backbone) |
| 5 | PLD | 99.0 | Oct 2025 | ICLR 2026 | Residual RL |
| 6 | **MPCoT** | **98.85** | Jun 2026 | arXiv | OFT parallel-decoding + multi-path latent CoT |
| 7 | SimpleVLA-RL | 98.83 | Sep 2025 | ICLR 2026 | AR + GRPO RL |
| 8 | DualCoT-VLA | 98.8 | Mar 2026 | — | Flow matching + parallel CoT |
| 9 | SnapFlow | 98.75 | Apr 2026 | — | One-step flow distillation (pi0.5 base) |
| 10 | **PearlVLA** | **98.70** | Jun 2026 | arXiv | Pearl-style action representation |
| 11 | **GEAR-VLA** | **98.67** | Jun 2026 | arXiv | Qwen2.5-VL + VGGT + DiT geometry-aware |
| 12 | 3DThinkVLA | 98.65 | Jun 2026 | arXiv | OFT regression + 3D-thinking-guided co-training |
| 13 | IntentVLA | 98.62 | May 2026 | — | DiT flow-matching + VGGT short-horizon intent |

> Full leaderboard with 137 LIBERO models → [Dashboard](https://hyeongjinkim.github.io/Vla-tracker-/) or [JSON](data/leaderboard.json)
...
| **RoboCasa** (avg) | StereoPolicy (75.6) | ACE-Ego-0 (72.8) | DIAL (70.2) |

---

## Paper Reviews

VLA-Tracker includes **270 AI-generated seminar-style paper reviews** for every tracked model. Each review covers:
...
**270 reviews are PDF-verified** — numbers cross-checked against actual paper tables.
...
| **llms-full.txt** | [/llms-full.txt](https://hyeongjinkim.github.io/Vla-tracker-/llms-full.txt) | Complete model database (5700+ lines) |
...
| **YAML** | [data/models/](data/models/) | Individual model files (270 files) |
...
|-----------|-------|--------|-------|-------|
| [LIBERO](data/benchmarks/libero.yaml) | 4 suites | 137 | Manipulation generalization | NeurIPS 2023 |
| [CALVIN](data/benchmarks/calvin.yaml) | ABC→D | 35 | Long-horizon, language | RA-L 2022 |
| [SimplerEnv](data/benchmarks/simpler_env.yaml) | 5 tasks | 43 | Sim-to-real transfer | NeurIPS 2024 |
| [RoboTwin v1/v2](data/benchmarks/robotwin.yaml) | 50+ tasks | 49 | Bimanual manipulation | CVPR 2025 |
| [RLBench](data/benchmarks/rlbench.yaml) | 18 tasks | 6 | Diverse manipulation | RA-L 2020 |
| [RoboCasa](data/benchmarks/robocasa.yaml) | Various | 22 | Home robot tasks | RSS 2024 |
...
```
├── data/
│   ├── models/              # 270 model YAML files (source of truth)
│   ├── benchmarks/          # 8 benchmark definitions
│   ├── ai_reviews/          # 270 AI-generated paper reviews (markdown)
...
- AI reviews are generated by Claude and may contain inaccuracies (270/270 are PDF-verified)
