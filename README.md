...
[![Models](https://img.shields.io/badge/Models-134-purple?style=flat-square)](data/models/)
...
**134 VLA models** · **8 benchmarks** · **122 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (134 files) |
...
```
├── data/
│   ├── models/              # 134 model YAML files (source of truth)
