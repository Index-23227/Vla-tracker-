...
[![AI Reviews](https://img.shields.io/badge/Paper_Reviews-97-orange?style=flat-square)](data/ai_reviews/)
...
**112 VLA models** · **8 benchmarks** · **97 AI paper reviews** · **Auto-updated from arXiv**
...
VLA-Tracker includes **97 AI-generated seminar-style paper reviews** for every tracked model. Each review covers:
...
**52 reviews are PDF-verified** — numbers cross-checked against actual paper tables.
...
│   ├── ai_reviews/          # 97 AI-generated paper reviews (markdown)
...
- AI reviews are generated by Claude and may contain inaccuracies (52/97 are PDF-verified)
