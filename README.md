...
[![Models](https://img.shields.io/badge/Models-136-purple?style=flat-square)](data/models/)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-8-green?style=flat-square)](data/benchmarks/)
[![AI Reviews](https://img.shields.io/badge/Paper_Reviews-136-orange?style=flat-square)](data/ai_reviews/)
...
**136 VLA models** · **8 benchmarks** · **136 AI paper reviews** · **Auto-updated from arXiv**
...
VLA-Tracker includes **136 AI-generated seminar-style paper reviews** for every tracked model. Each review covers:
...
**136 reviews are PDF-verified** — numbers cross-checked against actual paper tables.
...
| **YAML** | [data/models/](data/models/) | Individual model files (136 files) |
...
|-----------|-------|--------|-------|-------|
| [LIBERO](data/benchmarks/libero.yaml) | 4 suites | 67 | Manipulation generalization | NeurIPS 2023 |
| [CALVIN](data/benchmarks/calvin.yaml) | ABC→D | 23 | Long-horizon, language | RA-L 2022 |
| [SimplerEnv](data/benchmarks/simpler_env.yaml) | 5 tasks | 24 | Sim-to-real transfer | NeurIPS 2024 |
| [RoboTwin v1/v2](data/benchmarks/robotwin.yaml) | 50+ tasks | 23 | Bimanual manipulation | CVPR 2025 |
| [RLBench](data/benchmarks/rlbench.yaml) | 18 tasks | 5 | Diverse manipulation | RA-L 2020 |
| [RoboCasa](data/benchmarks/robocasa.yaml) | Various | 14 | Home robot tasks | RSS 2024 |
...
```
├── data/
│   ├── models/              # 136 model YAML files (source of truth)
│   ├── benchmarks/          # 8 benchmark definitions
│   ├── ai_reviews/          # 136 AI-generated paper reviews (markdown)
...
- AI reviews are generated by Claude and may contain inaccuracies (136/136 are PDF-verified)
