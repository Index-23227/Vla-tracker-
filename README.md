...
[![Models](https://img.shields.io/badge/Models-84-purple?style=flat-square)](data/models/)
...
**84 VLA models** · **8 benchmarks** · **70 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (84 files) |
...
```
├── data/
│   ├── models/              # 84 model YAML files (source of truth)
