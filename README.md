...
[![Models](https://img.shields.io/badge/Models-216-purple?style=flat-square)](data/models/)
...
**216 VLA models** · **8 benchmarks** · **216 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (216 files) |
...
```
├── data/
│   ├── models/              # 216 model YAML files (source of truth)
