...
[![Models](https://img.shields.io/badge/Models-103-purple?style=flat-square)](data/models/)
...
**103 VLA models** · **8 benchmarks** · **75 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (103 files) |
...
```
├── data/
│   ├── models/              # 103 model YAML files (source of truth)
