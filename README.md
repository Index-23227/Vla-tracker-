...
[![Models](https://img.shields.io/badge/Models-339-purple?style=flat-square)](data/models/)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-8-green?style=flat-square)](data/benchmarks/)
[![AI Reviews](https://img.shields.io/badge/Paper_Reviews-339-orange?style=flat-square)](data/ai_reviews/)
...
**339 VLA models** · **8 benchmarks** · **339 AI paper reviews** · **Auto-updated from arXiv**
...
| Paper reviews | None | **339 AI-generated seminar-style reviews** |
...
> Full leaderboard with 167 LIBERO models → [Dashboard](https://hyeongjinkim.github.io/Vla-tracker-/) or [JSON](data/leaderboard.json)
...
VLA-Tracker includes **339 AI-generated seminar-style paper reviews** for every tracked model. Each review covers:
...
**339 reviews are PDF-verified** — numbers cross-checked against actual paper tables.
...
| **llms-full.txt** | [/llms-full.txt](https://hyeongjinkim.github.io/Vla-tracker-/llms-full.txt) | Complete model database (6900+ lines) |
...
| **YAML** | [data/models/](data/models/) | Individual model files (339 files) |
...
|-----------|-------|--------|-------|-------|
| [LIBERO](data/benchmarks/libero.yaml) | 4 suites | 167 | Manipulation generalization | NeurIPS 2023 |
| [CALVIN](data/benchmarks/calvin.yaml) | ABC→D | 39 | Long-horizon, language | RA-L 2022 |
...
| [RoboCasa](data/benchmarks/robocasa.yaml) | Various | 28 | Home robot tasks | RSS 2024 |
...
```
├── data/
│   ├── models/              # 339 model YAML files (source of truth)
│   ├── benchmarks/          # 8 benchmark definitions
│   ├── ai_reviews/          # 339 AI-generated paper reviews (markdown)
...
- AI reviews are generated by Claude and may contain inaccuracies (339/339 are PDF-verified)
