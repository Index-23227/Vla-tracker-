...
[![Models](https://img.shields.io/badge/Models-135-purple?style=flat-square)](data/models/)
...
**135 VLA models** · **8 benchmarks** · **122 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (135 files) |
...
```
├── data/
│   ├── models/              # 135 model YAML files (source of truth)
