...
[![Models](https://img.shields.io/badge/Models-387-purple?style=flat-square)](data/models/)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-8-green?style=flat-square)](data/benchmarks/)
[![AI Reviews](https://img.shields.io/badge/Paper_Reviews-385-orange?style=flat-square)](data/ai_reviews/)
...
**387 VLA models** · **8 benchmarks** · **385 AI paper reviews** · **Auto-updated from arXiv**
...
| Paper reviews | None | **385 AI-generated seminar-style reviews** |
...
> Full leaderboard with 199 LIBERO models → [Dashboard](https://hyeongjinkim.github.io/Vla-tracker-/) or [JSON](data/leaderboard.json)
...
VLA-Tracker includes **385 AI-generated seminar-style paper reviews** for every tracked model. Each review covers:
...
**385 reviews are PDF-verified** — numbers cross-checked against actual paper tables.
...
| **YAML** | [data/models/](data/models/) | Individual model files (387 files) |
...
|-----------|-------|--------|-------|-------|
| [LIBERO](data/benchmarks/libero.yaml) | 4 suites | 199 | Manipulation generalization | NeurIPS 2023 |
| [CALVIN](data/benchmarks/calvin.yaml) | ABC→D | 46 | Long-horizon, language | RA-L 2022 |
| [SimplerEnv](data/benchmarks/simpler_env.yaml) | 5 tasks | 52 | Sim-to-real transfer | NeurIPS 2024 |
...
```
├── data/
│   ├── models/              # 387 model YAML files (source of truth)
│   ├── benchmarks/          # 8 benchmark definitions
│   ├── ai_reviews/          # 385 AI-generated paper reviews (markdown)
...
- AI reviews are generated by Claude and may contain inaccuracies (385/385 are PDF-verified)
