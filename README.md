...
[![Models](https://img.shields.io/badge/Models-96-purple?style=flat-square)](data/models/)
...
**96 VLA models** · **8 benchmarks** · **75 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (96 files) |
...
```
├── data/
│   ├── models/              # 96 model YAML files (source of truth)
