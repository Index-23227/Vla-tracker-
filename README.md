...
[![Models](https://img.shields.io/badge/Models-307-purple?style=flat-square)](data/models/)
...
**307 VLA models** · **8 benchmarks** · **304 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (307 files) |
...
```
├── data/
│   ├── models/              # 307 model YAML files (source of truth)
