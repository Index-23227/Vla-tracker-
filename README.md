...
[![Models](https://img.shields.io/badge/Models-200-purple?style=flat-square)](data/models/)
...
**200 VLA models** · **8 benchmarks** · **200 AI paper reviews** · **Auto-updated from arXiv**
...
```
├── data/
│   ├── models/              # 200 model YAML files (source of truth)
