...
[![Models](https://img.shields.io/badge/Models-138-purple?style=flat-square)](data/models/)
...
**138 VLA models** · **8 benchmarks** · **122 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (138 files) |
...
```
├── data/
│   ├── models/              # 138 model YAML files (source of truth)
