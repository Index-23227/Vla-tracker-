...
[![Models](https://img.shields.io/badge/Models-335-purple?style=flat-square)](data/models/)
...
**335 VLA models** · **8 benchmarks** · **331 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (335 files) |
...
```
├── data/
│   ├── models/              # 335 model YAML files (source of truth)
