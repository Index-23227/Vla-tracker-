...
[![Models](https://img.shields.io/badge/Models-283-purple?style=flat-square)](data/models/)
...
**283 VLA models** · **8 benchmarks** · **283 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (283 files) |
...
```
├── data/
│   ├── models/              # 283 model YAML files (source of truth)
