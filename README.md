...
[![Models](https://img.shields.io/badge/Models-251-purple?style=flat-square)](data/models/)
...
**251 VLA models** · **8 benchmarks** · **246 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (251 files) |
...
```
├── data/
│   ├── models/              # 251 model YAML files (source of truth)
