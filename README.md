...
[![Models](https://img.shields.io/badge/Models-126-purple?style=flat-square)](data/models/)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-8-green?style=flat-square)](data/benchmarks/)
[![AI Reviews](https://img.shields.io/badge/Paper_Reviews-88-orange?style=flat-square)](data/ai_reviews/)
...
**126 VLA models** · **8 benchmarks** · **88 AI paper reviews** · **Auto-updated from arXiv**
...
VLA-Tracker includes **88 AI-generated seminar-style paper reviews** for every tracked model. Each review covers:
...
| **YAML** | [data/models/](data/models/) | Individual model files (126 files) |
...
```
├── data/
│   ├── models/              # 126 model YAML files (source of truth)
│   ├── benchmarks/          # 8 benchmark definitions
│   ├── ai_reviews/          # 88 AI-generated paper reviews (markdown)
...
- AI reviews are generated by Claude and may contain inaccuracies (30/88 are PDF-verified)
