...
[![Models](https://img.shields.io/badge/Models-348-purple?style=flat-square)](data/models/)
...
**348 VLA models** · **8 benchmarks** · **348 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (348 files) |
...
```
├── data/
│   ├── models/              # 348 model YAML files (source of truth)
