...
[![Models](https://img.shields.io/badge/Models-293-purple?style=flat-square)](data/models/)
...
**293 VLA models** · **8 benchmarks** · **289 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (293 files) |
...
```
├── data/
│   ├── models/              # 293 model YAML files (source of truth)
