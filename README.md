...
[![Models](https://img.shields.io/badge/Models-183-purple?style=flat-square)](data/models/)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-8-green?style=flat-square)](data/benchmarks/)
[![AI Reviews](https://img.shields.io/badge/Paper_Reviews-183-orange?style=flat-square)](data/ai_reviews/)
...
**183 VLA models** · **8 benchmarks** · **183 AI paper reviews** · **Auto-updated from arXiv**
...
VLA-Tracker includes **183 AI-generated seminar-style paper reviews** for every tracked model. Each review covers:
...
**183 reviews are PDF-verified** — numbers cross-checked against actual paper tables.
...
| **YAML** | [data/models/](data/models/) | Individual model files (183 files) |
...
|-----------|-------|--------|-------|-------|
| [LIBERO](data/benchmarks/libero.yaml) | 4 suites | 91 | Manipulation generalization | NeurIPS 2023 |
| [CALVIN](data/benchmarks/calvin.yaml) | ABC→D | 26 | Long-horizon, language | RA-L 2022 |
| [SimplerEnv](data/benchmarks/simpler_env.yaml) | 5 tasks | 33 | Sim-to-real transfer | NeurIPS 2024 |
...
```
├── data/
│   ├── models/              # 183 model YAML files (source of truth)
│   ├── benchmarks/          # 8 benchmark definitions
│   ├── ai_reviews/          # 183 AI-generated paper reviews (markdown)
...
- AI reviews are generated by Claude and may contain inaccuracies (183/183 are PDF-verified)
