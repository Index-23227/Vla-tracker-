...
[![Models](https://img.shields.io/badge/Models-344-purple?style=flat-square)](data/models/)
...
**344 VLA models** · **8 benchmarks** · **339 AI paper reviews** · **Auto-updated from arXiv**
...
| **llms-full.txt** | [/llms-full.txt](https://hyeongjinkim.github.io/Vla-tracker-/llms-full.txt) | Complete model database (7100+ lines) |
...
| **YAML** | [data/models/](data/models/) | Individual model files (344 files) |
...
```
├── data/
│   ├── models/              # 344 model YAML files (source of truth)
