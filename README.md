...
[![Models](https://img.shields.io/badge/Models-105-purple?style=flat-square)](data/models/)
...
**105 VLA models** · **8 benchmarks** · **75 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (105 files) |
...
```
├── data/
│   ├── models/              # 105 model YAML files (source of truth)
