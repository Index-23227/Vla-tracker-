...
[![Models](https://img.shields.io/badge/Models-127-purple?style=flat-square)](data/models/)
...
**127 VLA models** · **8 benchmarks** · **122 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (127 files) |
...
```
├── data/
│   ├── models/              # 127 model YAML files (source of truth)
