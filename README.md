...
[![Models](https://img.shields.io/badge/Models-246-purple?style=flat-square)](data/models/)
...
**246 VLA models** · **8 benchmarks** · **246 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (246 files) |
...
```
├── data/
│   ├── models/              # 246 model YAML files (source of truth)
