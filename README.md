...
|-----------|-------|--------|-------|-------|
| [LIBERO](data/benchmarks/libero.yaml) | 4 suites | 55 | Manipulation generalization | NeurIPS 2023 |
...
| [RoboTwin v1/v2](data/benchmarks/robotwin.yaml) | 50+ tasks | 15 | Bimanual manipulation | CVPR 2025 |
| [RLBench](data/benchmarks/rlbench.yaml) | 18 tasks | 3 | Diverse manipulation | RA-L 2020 |
| [RoboCasa](data/benchmarks/robocasa.yaml) | Various | 11 | Home robot tasks | RSS 2024 |
...
- AI reviews are generated by Claude and may contain inaccuracies (110/128 are PDF-verified)
