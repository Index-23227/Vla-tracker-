...
[![AI Reviews](https://img.shields.io/badge/Paper_Reviews-198-orange?style=flat-square)](data/ai_reviews/)
...
**200 VLA models** · **8 benchmarks** · **198 AI paper reviews** · **Auto-updated from arXiv**
...
VLA-Tracker includes **198 AI-generated seminar-style paper reviews** for every tracked model. Each review covers:
...
**196 reviews are PDF-verified** — numbers cross-checked against actual paper tables.
...
|-----------|-------|--------|-------|-------|
| [LIBERO](data/benchmarks/libero.yaml) | 4 suites | 98 | Manipulation generalization | NeurIPS 2023 |
...
│   ├── ai_reviews/          # 198 AI-generated paper reviews (markdown)
...
- AI reviews are generated by Claude and may contain inaccuracies (196/198 are PDF-verified)
