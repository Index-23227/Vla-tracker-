...
[![Models](https://img.shields.io/badge/Models-132-purple?style=flat-square)](data/models/)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-8-green?style=flat-square)](data/benchmarks/)
[![AI Reviews](https://img.shields.io/badge/Paper_Reviews-122-orange?style=flat-square)](data/ai_reviews/)
...
**132 VLA models** · **8 benchmarks** · **122 AI paper reviews** · **Auto-updated from arXiv**
...
|------|-------|-----|------|-------|-------------|
| 1 | **LaST-R1** | **99.8** | Apr 2026 | — | Autoregressive + LAPO RL (latent CoT) |
| 2 | **PLD** | **99.0** | Oct 2025 | ICLR 2026 | Residual RL |
| 3 | **SimpleVLA-RL** | **98.8** | Sep 2025 | ICLR 2026 | AR + GRPO RL |
| 4 | **DualCoT-VLA** | **98.8** | Mar 2026 | — | Flow matching + parallel CoT |
| 5 | **SnapFlow** | **98.8** | Apr 2026 | — | One-step flow distillation (pi0.5 base) |
| 6 | DiT4DiT | 98.6 | Mar 2026 | — | Cosmos DiT + flow-matching action |
| 7 | LaMP | 98.3 | Mar 2026 | — | Qwen3-VL + flow matching (3D scene flow) |
| 8 | MMaDA-VLA | 98.0 | Mar 2026 | — | Discrete diffusion (masked token denoising) |
| 9 | TAG | 97.9 | Mar 2026 | — | Test-time guidance on pi0.5 |
| 10 | VLA-IAP | 97.8 | Mar 2026 | — | Training-free token pruning |
| 11 | X-VLA | 97.8 | Oct 2025 | ICLR 2026 | Flow matching + soft prompts |
| 12 | DepthCache | 97.6 | Mar 2026 | — | Depth-guided token merging (training-free) |
| 13 | Fast-WAM | 97.6 | Mar 2026 | — | Flow + video DiT |
| 14 | OmniVLA-RL | 97.6 | Apr 2026 | — | Flow matching + Flow-GSPO RL |
| 15 | TriRelVLA | 97.5 | May 2026 | — | MLP regression + triadic relational graph |
...
| **RoboTwin v2** (avg) | MotuBrain (96.0) | STARRY (93.6) | Motus (87.8) |
...
VLA-Tracker includes **122 AI-generated seminar-style paper reviews** for every tracked model. Each review covers:
...
**117 reviews are PDF-verified** — numbers cross-checked against actual paper tables.
...
| **YAML** | [data/models/](data/models/) | Individual model files (132 files) |
...
|-----------|-------|--------|-------|-------|
| [LIBERO](data/benchmarks/libero.yaml) | 4 suites | 54 | Manipulation generalization | NeurIPS 2023 |
...
| [RoboTwin v1/v2](data/benchmarks/robotwin.yaml) | 50+ tasks | 14 | Bimanual manipulation | CVPR 2025 |
| [RLBench](data/benchmarks/rlbench.yaml) | 18 tasks | 4 | Diverse manipulation | RA-L 2020 |
...
```
├── data/
│   ├── models/              # 132 model YAML files (source of truth)
│   ├── benchmarks/          # 8 benchmark definitions
│   ├── ai_reviews/          # 122 AI-generated paper reviews (markdown)
...
- AI reviews are generated by Claude and may contain inaccuracies (117/122 are PDF-verified)
