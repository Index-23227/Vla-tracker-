...
[![Models](https://img.shields.io/badge/Models-137-purple?style=flat-square)](data/models/)
...
**137 VLA models** · **8 benchmarks** · **122 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (137 files) |
...
```
├── data/
│   ├── models/              # 137 model YAML files (source of truth)
