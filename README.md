...
[![Models](https://img.shields.io/badge/Models-215-purple?style=flat-square)](data/models/)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-8-green?style=flat-square)](data/benchmarks/)
[![AI Reviews](https://img.shields.io/badge/Paper_Reviews-215-orange?style=flat-square)](data/ai_reviews/)
...
**215 VLA models** · **8 benchmarks** · **215 AI paper reviews** · **Auto-updated from arXiv**
...
| Paper reviews | None | **215 AI-generated seminar-style reviews** |
...
VLA-Tracker includes **215 AI-generated seminar-style paper reviews** for every tracked model. Each review covers:
...
**215 reviews are PDF-verified** — numbers cross-checked against actual paper tables.
...
| **YAML** | [data/models/](data/models/) | Individual model files (215 files) |
...
```
├── data/
│   ├── models/              # 215 model YAML files (source of truth)
│   ├── benchmarks/          # 8 benchmark definitions
│   ├── ai_reviews/          # 215 AI-generated paper reviews (markdown)
...
- AI reviews are generated by Claude and may contain inaccuracies (215/215 are PDF-verified)
