...
[![Models](https://img.shields.io/badge/Models-99-purple?style=flat-square)](data/models/)
...
**99 VLA models** · **8 benchmarks** · **75 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (99 files) |
...
```
├── data/
│   ├── models/              # 99 model YAML files (source of truth)
