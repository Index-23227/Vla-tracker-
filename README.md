...
[![Models](https://img.shields.io/badge/Models-393-purple?style=flat-square)](data/models/)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-8-green?style=flat-square)](data/benchmarks/)
[![AI Reviews](https://img.shields.io/badge/Paper_Reviews-393-orange?style=flat-square)](data/ai_reviews/)
...
**393 VLA models** · **8 benchmarks** · **393 AI paper reviews** · **Auto-updated from arXiv**
...
| Paper reviews | None | **393 AI-generated seminar-style reviews** |
...
> Full leaderboard with 202 LIBERO models → [Dashboard](https://hyeongjinkim.github.io/Vla-tracker-/) or [JSON](data/leaderboard.json)
...
VLA-Tracker includes **393 AI-generated seminar-style paper reviews** for every tracked model. Each review covers:
...
**393 reviews are PDF-verified** — numbers cross-checked against actual paper tables.
...
| **llms-full.txt** | [/llms-full.txt](https://hyeongjinkim.github.io/Vla-tracker-/llms-full.txt) | Complete model database (8100+ lines) |
...
| **YAML** | [data/models/](data/models/) | Individual model files (393 files) |
...
|-----------|-------|--------|-------|-------|
| [LIBERO](data/benchmarks/libero.yaml) | 4 suites | 202 | Manipulation generalization | NeurIPS 2023 |
| [CALVIN](data/benchmarks/calvin.yaml) | ABC→D | 46 | Long-horizon, language | RA-L 2022 |
| [SimplerEnv](data/benchmarks/simpler_env.yaml) | 5 tasks | 53 | Sim-to-real transfer | NeurIPS 2024 |
| [RoboTwin v1/v2](data/benchmarks/robotwin.yaml) | 50+ tasks | 67 | Bimanual manipulation | CVPR 2025 |
...
```
├── data/
│   ├── models/              # 393 model YAML files (source of truth)
│   ├── benchmarks/          # 8 benchmark definitions
│   ├── ai_reviews/          # 393 AI-generated paper reviews (markdown)
...
- AI reviews are generated by Claude and may contain inaccuracies (393/393 are PDF-verified)
