...
[![Models](https://img.shields.io/badge/Models-115-purple?style=flat-square)](data/models/)
...
**115 VLA models** · **8 benchmarks** · **112 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (115 files) |
...
```
├── data/
│   ├── models/              # 115 model YAML files (source of truth)
