...
[![Models](https://img.shields.io/badge/Models-107-purple?style=flat-square)](data/models/)
...
**107 VLA models** · **8 benchmarks** · **75 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (107 files) |
...
```
├── data/
│   ├── models/              # 107 model YAML files (source of truth)
