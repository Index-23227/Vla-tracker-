...
[![Models](https://img.shields.io/badge/Models-397-purple?style=flat-square)](data/models/)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-8-green?style=flat-square)](data/benchmarks/)
[![AI Reviews](https://img.shields.io/badge/Paper_Reviews-397-orange?style=flat-square)](data/ai_reviews/)
...
**397 VLA models** · **8 benchmarks** · **397 AI paper reviews** · **Auto-updated from arXiv**
...
| Paper reviews | None | **397 AI-generated seminar-style reviews** |
...
VLA-Tracker includes **397 AI-generated seminar-style paper reviews** for every tracked model. Each review covers:
...
**397 reviews are PDF-verified** — numbers cross-checked against actual paper tables.
...
| **YAML** | [data/models/](data/models/) | Individual model files (397 files) |
...
```
├── data/
│   ├── models/              # 397 model YAML files (source of truth)
│   ├── benchmarks/          # 8 benchmark definitions
│   ├── ai_reviews/          # 397 AI-generated paper reviews (markdown)
...
- AI reviews are generated by Claude and may contain inaccuracies (397/397 are PDF-verified)
