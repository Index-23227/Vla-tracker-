...
[![Models](https://img.shields.io/badge/Models-129-purple?style=flat-square)](data/models/)
...
**129 VLA models** · **8 benchmarks** · **122 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (129 files) |
...
```
├── data/
│   ├── models/              # 129 model YAML files (source of truth)
