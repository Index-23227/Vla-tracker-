...
[![Models](https://img.shields.io/badge/Models-80-purple?style=flat-square)](data/models/)
...
**80 VLA models** · **8 benchmarks** · **70 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (80 files) |
...
```
├── data/
│   ├── models/              # 80 model YAML files (source of truth)
