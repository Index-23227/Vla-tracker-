...
[![Models](https://img.shields.io/badge/Models-164-purple?style=flat-square)](data/models/)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-8-green?style=flat-square)](data/benchmarks/)
[![AI Reviews](https://img.shields.io/badge/Paper_Reviews-164-orange?style=flat-square)](data/ai_reviews/)
...
**164 VLA models** · **8 benchmarks** · **164 AI paper reviews** · **Auto-updated from arXiv**
...
VLA-Tracker includes **164 AI-generated seminar-style paper reviews** for every tracked model. Each review covers:
...
**164 reviews are PDF-verified** — numbers cross-checked against actual paper tables.
...
| **YAML** | [data/models/](data/models/) | Individual model files (164 files) |
...
|-----------|-------|--------|-------|-------|
| [LIBERO](data/benchmarks/libero.yaml) | 4 suites | 80 | Manipulation generalization | NeurIPS 2023 |
| [CALVIN](data/benchmarks/calvin.yaml) | ABC→D | 26 | Long-horizon, language | RA-L 2022 |
| [SimplerEnv](data/benchmarks/simpler_env.yaml) | 5 tasks | 28 | Sim-to-real transfer | NeurIPS 2024 |
| [RoboTwin v1/v2](data/benchmarks/robotwin.yaml) | 50+ tasks | 29 | Bimanual manipulation | CVPR 2025 |
| [RLBench](data/benchmarks/rlbench.yaml) | 18 tasks | 5 | Diverse manipulation | RA-L 2020 |
| [RoboCasa](data/benchmarks/robocasa.yaml) | Various | 16 | Home robot tasks | RSS 2024 |
...
```
├── data/
│   ├── models/              # 164 model YAML files (source of truth)
│   ├── benchmarks/          # 8 benchmark definitions
│   ├── ai_reviews/          # 164 AI-generated paper reviews (markdown)
...
- AI reviews are generated by Claude and may contain inaccuracies (164/164 are PDF-verified)
