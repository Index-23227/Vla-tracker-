...
[![Models](https://img.shields.io/badge/Models-274-purple?style=flat-square)](data/models/)
...
**274 VLA models** · **8 benchmarks** · **270 AI paper reviews** · **Auto-updated from arXiv**
...
| **YAML** | [data/models/](data/models/) | Individual model files (274 files) |
...
```
├── data/
│   ├── models/              # 274 model YAML files (source of truth)
